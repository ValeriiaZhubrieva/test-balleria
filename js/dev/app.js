  ...
  open(selectorValue) {
    if (bodyLockStatus) {
      ...
      if (this.targetOpen.element) {
        ...
        const videoEl = this.targetOpen.element.querySelector("video");
        if (videoEl) {
          videoEl.play().catch(() => {
          });
        }
...
const videoBlockPreview = document.querySelector("[data-video-autoplay]");
const videoBlockPreviewVideo = videoBlockPreview?.querySelector("video");
if (videoBlockPreview && videoBlockPreviewVideo) {
